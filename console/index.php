...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <?php if ($result[0]['game_success'] == 3) {?><tr><td valign="top"><img src="/icons/unknown.gif" alt="[   ]"></td><td><a href=<?php echo str_shuffle(substr("0123456789", 0, rand(7,12)))."@terminal";?>">Console</a>            </td><td align="right">2021-10-13 14:37  </td><td align="right"> 13K</td><td>&nbsp;</td></tr><?php }?>
        ...
        <address>Apache/2.4.39 (Linux) PHP/7.4.0 Server at utdarma Port 443</address>
    </body>
</html>